...
namespace SmartAuditX.Migrations
{
    ...
    [Migration("20260604181804_UpdatedtheCompanyContactModel")]
    partial class UpdatedtheCompanyContactModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartAuditX.Models.CompanySubscription", b =>
                {
            ...
            modelBuilder.Entity("SmartAuditX.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("SmartAuditX.Models.SubscriptionPlan", b =>
                {
                    b.Property<int>("SubscriptionPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartAuditX.Models.SubscriptionPlanFeature", b =>
                {
            ...
            modelBuilder.Entity("SmartAuditX.Models.SubscriptionPlanPricing", b =>
                {
                    b.Property<int>("SubscriptionPlanPricingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubscriptionPlanPricing");
                });
            ...
            modelBuilder.Entity("SmartAuditX.Models.CompanySubscription", b =>
                {
                    ...
                    b.HasOne("SmartAuditX.Models.SubscriptionPlan", null)
                        .WithMany("CompanySubscriptions")
                        .HasForeignKey("SubscriptionPlanId");

                    b.HasOne("SmartAuditX.Models.SubscriptionPlanPricing", "SubscriptionPlanPricing")
                        .WithMany("CompanySubscriptions")
            ...
            modelBuilder.Entity("SmartAuditX.Models.Payment", b =>
                {
                    b.HasOne("SmartAuditX.Models.CompanySubscription", "CompanySubscription")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("SmartAuditX.Models.SubscriptionPlanFeature", b =>
                {
                    b.HasOne("SmartAuditX.Models.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("Features")
                        .HasForeignKey("SubscriptionPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
