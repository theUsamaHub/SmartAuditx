    ...
    public partial class InitialSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchDepartments", x => x.BranchDepartmentId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "ConcurrencyStamp", "CreatedAt", "Description", "IsActive", "Name", "NormalizedName" },
                values: new object[,]
                {
                    { 1, "8f4c6a90-1111-2222-3333-444444444444", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Full platform administration access", true, "SystemAdmin", "SYSTEMADMIN" },
                    { 2, "8f4c6a21-1111-2222-3333-444444444444", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Company owner with company-level access", true, "CompanyOwner", "COMPANYOWNER" },
                    { 3, "11111111-1111-1111-1111-111111111111", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Department and employee management access", true, "Manager", "MANAGER" },
                    { 4, "8f4c6a90-2123-2222-3333-444444444444", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Audit and inspection related access", true, "Auditor", "AUDITOR" },
                    { 5, "22222222-2222-2222-2222-222222222222", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Basic system user access", true, "User", "USER" }
                });
